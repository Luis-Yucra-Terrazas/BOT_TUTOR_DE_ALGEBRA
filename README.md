BOT_TUTOR_DE_ALGEBRA

El proyecto Bot Tutor de Álgebra surge como una herramienta tecnológica diseñada para transformar la manera en que los estudiantes interactúan con las matemáticas. Su propósito principal es derribar la barrera de complejidad que suele asociarse con esta materia, ofreciendo un entorno de aprendizaje dinámico, accesible y personalizado.
A nivel funcional, el sistema se enfoca en los siguientes aspectos:
 * Comprensión de ecuaciones: El bot no solo entrega un resultado final, sino que guía al usuario paso a paso en el proceso de despeje y resolución, permitiendo que el estudiante entienda el *porqué* de cada procedimiento matemático.
